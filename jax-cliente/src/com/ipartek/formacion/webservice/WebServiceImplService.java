 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webservice.formacion.ipartek.com/", wsdlLocation = "http://localhost:8080/jax-ws/sayhello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.formacion.ipartek.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jax-ws/sayhello?wsdl");
    ...
    public WebServiceInterface getWebServiceImplPort() {
        return super.getPort(new QName("http://webservice.formacion.ipartek.com/", "WebServiceImplPort"), WebServiceInterface.class);
    }
    ...
    public WebServiceInterface getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.formacion.ipartek.com/", "WebServiceImplPort"), WebServiceInterface.class, features);
    }
